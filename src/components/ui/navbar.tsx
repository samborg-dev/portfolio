...
const Navbar = () => {
    ...
    return (
        <div suppressHydrationWarning className="theme-container flex justify-center w-auto">
            <div className='navbar flex justify-center py-4 px-4 items-center h-16 bg-card fixed top-0 max-w-6xl mx-auto z-50 rounded-xl border-solid border-4 border-accent mt-2 sm:mt-4 md:mt-6 lg:mt-8'>
